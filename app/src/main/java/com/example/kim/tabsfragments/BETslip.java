...
public class BETslip extends AppCompatActivity {
    ...
    private void showlist()
    {
        ...
        StringRequest stringRequest= new StringRequest ( Request.Method.GET, " http://172.19.152.113/tipscoreJSON/betslip.php",
